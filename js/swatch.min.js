...
!(function ($) {
  ...
  function updateGroupVariant(t, e, a, i) {
    if (use_vimg && "#cart-form_qs" != t) {
      if ("#cart-form_ppr" == t) var o = ".sp-single .p-thumb";
      else if ("#cart-form_qv" == t) o = "#content_quickview";
      else o = ".wrap_qs_pr";
      $(o + ' [data-grname="not4"]').length != $(o + " [data-grname]").length &&
        0 != $(o + ' [data-grname="' + e + '"]').length &&
        ($(o + " .js-sl-item").addClass("is_varhide"),
        $(
          o +
            ' [data-grname="opnt4"], ' +
            o +
        ...
        "#cart-form_ppr" == t && 0 < $(".p-thumb.isotope_ok").length
          ...
          ? $(".p-thumb.flickity-enabled")
              .flickity("deactivate")
              .flickity("activate")
          : $(o + " .nt_carousel_qv.flickity-enabled")
              .flickity("deactivate")
              .flickity("activate"),
  ...
  function selectCallback(t, e, a, i, o, n, s, r, c, l, d, p, _) {
    ...
    var f = $(o),
      ...
      P = q.find(".txt_add"),
      M = q.find(".txt_pre"),
      O = ($("#pr_qty_mess" + s), $("#pr_incoming_mess" + s)),
      A = $(g).find(".js_in_stock"),
    ...
    if (
      (2 == i
        ? (f.attr("class", "nt_" + R), f.addClass("nt1_" + H))
        : 3 == i &&
          (f.attr("class", "nt_" + R),
          f.addClass("nt1_" + H),
          f.addClass("nt2_" + B)),
      ...
      if (t.available) {
        ...
        0 < t.inventory_quantity
          ...
          l &&
            ...
            t.incoming &&
            (O.find(".jsnt").text(t.next_incoming_date), O.show());
        var G = t.inventory_quantity <= 0 && null != t.inventory_management;
        G
          ? (P.hide(), M.show(), A.hide(), z.show())
          : (M.hide(), P.show(), z.hide(), A.show()),
          G
        ...
        I.find("textarea").text(
          X.replace("[variant]", t.title).replace("[url]", "?variant=" + t.id)
        );
      }
      ...
      if (t.compare_at_price > t.price) {
        ...
        K.find(">span").html(p.replace("[sale]", Math.ceil(et))), K.show();
      } else j.html(Q), K.hide();
      if (
        (t.unit_price &&
        ...
        0 < $(".p-thumb.isotope_ok").length
          ? updateImageVariantPositionIsotope(it)
          : updateImageVariantPositionSlider(e, at, c, s);
      }
      (c || ntla_ck) && (ntla_ck = !1),
      ...
      $("html, body").animate(
        {
          scrollTop:
            t.offset().top -
            $(".ntheader.live_stuck .sp_header_mid").outerHeight() -
            30,
        },
        250
      ),
                ...
                success: function (t) {
                  ...
                  "" !== e.trim()
                    ? $.magnificPopup.open({
                        items: {
                          src:
                            '<div class="popup_uppr_wrap container bgw mfp-with-anim">' +
                            e +
                            "</div>",
                          type: "inline",
                        },
  ...
  (geckoShopify.Ntproduct_switch = function (t, n, e, k, b, w, S, C) {
            ...
            switch (
              ...
              case 3:
                ...
                if ((n.val(d.id), I)) {
                  ...
                  var g,
                    m,
                    y = getVariantFromSize(2, q, x, c, l),
              ...
              null != o
                ...
                : (e.addClass("loading"),
                  ...
                  $.ajax({
                    ...
                    type: "GET",
                    success: function (t) {
                      n(t, i), sp_nt_storage && sessionStorage.setItem(i, t);
                    },
                    complete: function () {
    ...
    (geckoShopify.progressbar = function (t, e) {
      ...
      if (0 != s.length) {
        ...
        var a,
          ...
          d = s.data("bgprocess"),
          p = s.data("bgten"),
          _ = e || geckoShopify.getRandomInt(n, l);
        if (sp_nt_storage) {
          var f = sessionStorage.getItem("probar" + r);
          0 < f && (_ = f);
        }
        s.find(".count").text(_).css({ "background-color": "#fff", color: d }),
          s.find(".message").show(),
          ...
          "ATC" != s.data("type") &&
            ((a = setTimeout(function () {
              --_ < 1 && (_ = e || geckoShopify.getRandomInt(n, l)),
                s.find(".count").css({ "background-color": d, color: "#fff" }),
                setTimeout(function () {
                  s.find(".count").css({
      ...
      if (0 != e.length) {
        ...
        if (e.hasClass("nt_loop")) {
          ...
          for (y = 0; y < m; y++) {
            ...
            y == _ - 1 &&
              ((g = !0), (n = s[y].replace("24:00:00", "23:59:59")));
          }
          if (
            ((r = u + " " + n + " " + h),
            isValidDate(new Date(r)) ||
              (r = u + " " + n + " " + (h = InitTimzone(h))),
            p && g)
          )
        ...
        var b = a.find(".day").text(),
          ...
          S = a.find(".min").text(),
          C = a.find(".sec").text();
        e.countdown(o, { elapse: !0 }).on("update.countdown", function (t) {
          t.elapsed
            ? (e.html(""), a.hide())
            : (a.find(".mess_cd").show(),
              e.html(
    ...
    (geckoShopify.delivery_order = function (t) {
      ...
      if (0 != a.length) {
        ...
        if (
          ...
          var k = u.split(" "),
            b = k[0] + " 00:00:00 " + h;
          isValidDate((i = new Date(k[0] + " " + _ + " " + h))) ||
            ((h = InitTimzone(h)),
            (b = k[0] + " 00:00:00 " + h),
            (i = new Date(k[0] + " " + _ + " " + h))),
            (o = new Date(b)),
            (s = new Date(b)),
            (c = o.getDate()),
            y <= k[1].replace(/ /g, "").replace(/:/g, "") &&
              i.setDate(i.getDate() + 1);
        } else y <= m && i.setDate(i.getDate() + 1);
        for (
          o.setDate(c + l);
          o.setDate(o.getDate() + n), n++, -1 < g.indexOf(f[o.getDay()]);

        );
        for (
          a.find(".start_delivery").html(getToday(0, p, o)), s.setDate(c + d);
          s.setDate(s.getDate() + r), r++, -1 < g.indexOf(f[s.getDay()]);

        );
        if (
          (a.find(".end_delivery").html(getToday(0, p, s)), "19041994" != _)
        ) {
          var w = a.find(".h_delivery");
          w.countdown(i, { elapse: !0 }).on("update.countdown", function (t) {
            if (t.elapsed);
            else {
      ...
      0 != $(".sp-tabs .tab-heading").length &&
        $(document).on("click", ".sp-tabs .tab-heading", function (t) {
          ...
          0 == o.length && (o = e.closest(".shopify-section")),
            a.addClass("clicked_accordion"),
            a.hasClass("active")
              ? (a.removeClass("active"),
                a.find(".sp-tab-content").slideUp(300))
              : (i.find(".sp-tab").removeClass("active"),
                a.addClass("active"),
                i.find(".sp-tab-content").slideUp(150),
                a.find(".sp-tab-content").stop(!0, !0).slideDown(300),
                setTimeout(function () {
                  var t = i.find(".sp-tab.active .js_ck_view");
      ...
      if (!body.hasClass("js_search_false")) {
        ...
        body.on("keyup", ".js_iput_search", function (t, e) {
          ...
          body.on("click", function (t) {
            var e = t.target;
            $(e).is(".cl_h_search") ||
              $(e).parents().is(".cl_h_search") ||
              $(e).parents().is(".js_h_search") ||
    ...
    (geckoShopify.ThumLeftRight = function (t) {
      if (
        ...
        s.find(".btn_pnav_next"), s.find(".btn_pnav_prev");
        r.on("select.flickity", function (t, e) {
          if ((s.removeClass("t4_show"), !($(window).width() <= 1024))) {
            ...
            if (!(a <= i)) {
              ...
              var n =
                r.find(".flickity-slider .n-item").eq(e).position().top +
                r.position().top -
                (i + o) / 2;
              r.stop().animate({ scrollTop: n }, 400);
            }
          }
        }),
          s
