        ...
        init: function () {
          if (!l && !o) {
            ...
            i && (f.ui = new i(f, m)).init(),
              ...
              void 0 === z && (Te("initialLayout"), (z = A = m.getScrollY()));
            var n = "pswp--open ";
            for (
          ...
          if (0 !== e)
            if (
              ...
              if (
                ...
                return;
              Pe(Qe, V[1]), G || ((G = !0), Te("zoomGestureStarted"));
              var t = ht(Je, Qe),
                n = Pt(t);
              n >
  ...
  (function (e, t) {
    ...
    return function (o, s) {
      var n,
        ...
        T = function (e) {
          if (g) return !0;
          (e = e || window.event), v.timeToIdle && v.mouseUsed && !d && P();
          for (
            var t,
              n,
      ...
      (w.init = function () {
        ...
        s.extend(o.options, I, !0),
          ...
          e("unbindEvents", function () {
            E || M(),
              y && clearInterval(y),
              s.unbind(document, "mouseout", A),
              s.unbind(document, "mousemove", P),
          ...
          v.timeToIdle &&
            e("mouseUsed", function () {
              s.bind(document, "mousemove", P),
                s.bind(document, "mouseout", A),
